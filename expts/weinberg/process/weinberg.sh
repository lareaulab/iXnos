...
~/bowtie-1.2.1.1/bowtie -v 2 -p 36 -S --un $WEINBERG_PROC_DIR/weinberg.not_rrna.fastq \
	$GENOME_DIR/ScerRRNA \
...
~/bowtie-1.2.1.1/bowtie -v 2 -p 36 -S --un $WEINBERG_PROC_DIR/weinberg.not_ncrna.fastq \
...
~/bowtie-1.2.1.1/bowtie -a --norc -v 2 -p 36 -S --un $WEINBERG_PROC_DIR/weinberg.unmapped.fastq \
