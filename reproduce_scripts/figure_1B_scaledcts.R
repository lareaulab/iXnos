...
id = args[1] # eg YOL086C_13cds10 for ADH1
g.range1 = args[2] # eg 166
data_fname = args[3] # eg weinberg.te_set_bounds.size.27.31.trunc.20.20.min_cts.200.min_cod.100.top.500.data_table.txt
y_te_hat_fname = args[4] # eg nonneg_str_epoch30_y_te_hat.csv
out_fname = args[5]
...
# id = "YOL086C_13cds10" # choose your gene
...
# plot it! not cairo_pdf because italics were broken
#pdf( "figure_1B_scaled_frag.pdf", width=2.5, height=1.67, pointsize=7, useDingbats = F )
