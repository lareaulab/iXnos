...
leaveout_fname = args[1] # results/lareau/leaveout_series/leaveout_corrs.txt
full_fname = args[2] # results/lareau/feat_neighborhood_series/feat_neighborhood_corrs.txt
out_fname = args[3] # figure_2E_lareaucorrs.pdf
