...
leaveout_fname = args[1] # results/green/leaveout_series/leaveout_corrs.txt
full_fname = args[2] # results/green/feat_neighborhood_series/feat_neighborhood_corrs.txt
out_fname = args[3] # supp_figure_greencorrs.pdf
