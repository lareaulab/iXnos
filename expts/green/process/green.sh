...
~/bowtie-1.2.1.1/bowtie -v 2 -p 36 -S --un $GREEN_PROC_DIR/green.not_rrna.fastq \
	$GENOME_DIR/ScerRRNA \
	$GREEN_PROC_DIR/SRR5008134_SRR5008135.trimmed.fastq > $GREEN_PROC_DIR/green.rrna.sam 2> $GREEN_PROC_DIR/green.rrna.bowtiestats

~/bowtie-1.2.1.1/bowtie -v 2 -p 36 -S --un $GREEN_PROC_DIR/green.not_ncrna.fastq \
...
~/bowtie-1.2.1.1/bowtie -a --norc -v 2 -p 36 -S --un $GREEN_PROC_DIR/green.unmapped.fastq \
