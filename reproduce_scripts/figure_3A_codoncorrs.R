...
leaveout_fname = args[1] # results/weinberg/leaveout_series/leaveout_corrs.txt
full_fname = args[2] # results/weinberg/feat_neighborhood_series/feat_neighborhood_corrs.txt
out_fname = args[3] # figure_2A_corrs.pdf
